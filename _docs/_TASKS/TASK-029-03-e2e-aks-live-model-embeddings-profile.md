...
# TASK-029-03: `e2e-aks-live-embeddings` Profile
...
Add a dedicated live embeddings deployment and AKS validation path so the router proves embeddings end-to-end against real Azure OpenAI infrastructure.
