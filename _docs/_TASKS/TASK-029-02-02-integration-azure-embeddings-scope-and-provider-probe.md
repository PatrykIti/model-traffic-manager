...
# FileName: TASK-029-02-02-integration-azure-embeddings-scope-and-provider-probe.md
...
Add a dedicated Azure-only scope and test suite that proves direct Azure OpenAI embeddings calls through the repository auth and outbound adapters.
